...
public class StudentListFragment extends Fragment implements RecyclerViewAdapter.OnStudentClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final RecyclerView studentRecyclerView = view.findViewById(R.id.rv_student_list);
...
//                final Intent intentAddStudent = new Intent(mContext, ViewStudentActivity.class);
//                intentAddStudent.putExtra("INTENT_IS_FROM_ADD", true);
//                mListener.onAddData(intentAddStudent);
            }
        });
        return view;
    }
